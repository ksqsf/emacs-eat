...
This is a fork of [[https://codeberg.org/akib/emacs-eat/issues][emacs-eat by akib]] for my own use.  Changes:

1. Some PRs merged to be compatible with Emacs 31.
2. Make integration scripts recognize xterm for remote shells.  This
   is probably wrong but it works for me.


* Eat's original README
